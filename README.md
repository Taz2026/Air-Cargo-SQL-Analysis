...
The flights table serves as the central fact table, linking airlines and airports through foreign keys. This structure enables analysis of cargo performance, route efficiency, and operational reliability.
